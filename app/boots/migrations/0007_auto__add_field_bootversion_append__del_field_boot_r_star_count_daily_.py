...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Boot.r_star_count_daily'
        db.delete_column(u'boots_boot', 'r_star_count_daily')

        # Deleting field 'Boot.r_star_count_weekly'
        db.delete_column(u'boots_boot', 'r_star_count_weekly')

        # Deleting field 'Boot.r_star_count_monthly'
        db.delete_column(u'boots_boot', 'r_star_count_monthly')

        # Adding field 'Boot.r_star_count_day'
        db.add_column(u'boots_boot', 'r_star_count_day',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Boot.r_star_count_week'
        db.add_column(u'boots_boot', 'r_star_count_week',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Boot.r_star_count_month'
        db.add_column(u'boots_boot', 'r_star_count_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Boot.r_star_count_daily'
        db.add_column(u'boots_boot', 'r_star_count_daily',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Boot.r_star_count_weekly'
        db.add_column(u'boots_boot', 'r_star_count_weekly',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Boot.r_star_count_monthly'
        db.add_column(u'boots_boot', 'r_star_count_monthly',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Boot.r_star_count_day'
        db.delete_column(u'boots_boot', 'r_star_count_day')

        # Deleting field 'Boot.r_star_count_week'
        db.delete_column(u'boots_boot', 'r_star_count_week')

        # Deleting field 'Boot.r_star_count_month'
        db.delete_column(u'boots_boot', 'r_star_count_month')
    ...
    models = {
        ...
        u'boots.bootversion': {
            ...
            'append': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Boot.r_star_count'
        db.add_column(u'boots_boot', 'r_star_count',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Boot.r_star_count'
        db.delete_column(u'boots_boot', 'r_star_count')
    ...
    models = {
        ...
        u'boots.boot': {
            ...
            'r_star_count_daily': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'r_star_count_monthly': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'r_star_count_weekly': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.CharField', [], {'max_length': '50', 'db_index': 'True'}),

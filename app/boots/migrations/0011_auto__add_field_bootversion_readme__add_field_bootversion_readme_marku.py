...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BootVersion.readme'
        db.add_column(u'boots_bootversion', 'readme',
                      self.gf('markupfield.fields.MarkupField')(null=True, rendered_field=True, blank=True),
                      keep_default=False)

        # Adding field 'BootVersion.readme_markup_type'
        db.add_column(u'boots_bootversion', 'readme_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'BootVersion._readme_rendered'
        db.add_column(u'boots_bootversion', '_readme_rendered',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BootVersion.readme'
        db.delete_column(u'boots_bootversion', 'readme')

        # Deleting field 'BootVersion.readme_markup_type'
        db.delete_column(u'boots_bootversion', 'readme_markup_type')

        # Deleting field 'BootVersion._readme_rendered'
        db.delete_column(u'boots_bootversion', '_readme_rendered')
    ...
    models = {
        ...
        u'boots.bootversion': {
            ...
            '_readme_rendered': ('django.db.models.fields.TextField', [], {}),
            ...
            'readme': ('markupfield.fields.MarkupField', [], {'null': 'True', 'rendered_field': 'True', 'blank': 'True'}),
            'readme_markup_type': ('django.db.models.fields.CharField', [], {'default': "'markdown'", 'max_length': '30', 'blank': 'True'}),
            'slug': ('django.db.models.CharField', [], {'max_length': '50', 'db_index': 'True'})
        },
        u'boots.star': {

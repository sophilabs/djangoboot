...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Star'
        db.create_table(u'boots_star', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('boot', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stars', to=orm['boots.Boot'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'boots', ['Star'])

        # Adding unique constraint on 'Star', fields ['boot', 'user']
        db.create_unique(u'boots_star', ['boot_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Star', fields ['boot', 'user']
        db.delete_unique(u'boots_star', ['boot_id', 'user_id'])

        # Deleting model 'Star'
        db.delete_table(u'boots_star')

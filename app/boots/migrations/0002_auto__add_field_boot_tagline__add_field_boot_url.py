...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Boot.tagline'
        db.add_column(u'boots_boot', 'tagline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)

        # Adding field 'Boot.url'
        db.add_column(u'boots_boot', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Boot.tagline'
        db.delete_column(u'boots_boot', 'tagline')

        # Deleting field 'Boot.url'
        db.delete_column(u'boots_boot', 'url')
